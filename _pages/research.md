...
Additionally, I keep an active collaboration with [Davide Dominoni](https://www.davidedominoni.com/), at the [University of Glasgow](https://www.gla.ac.uk/), where we study (i) **circadian patterns of behavioural and physiological activity** in urban and non-urban passerine birds; and, (ii) **anthropogenic effects on the gut microbiomes** of wild birds and their consequences for adaptation to these environments and for animal welfare. I did my PhD at University of Exeter, working with [Andy Young](http://www.animalsocieties.org) on the evolution of cooperative breeding, unsing the incredible [white-browed sparrow weavers](http://www.animalsocieties.org/sparrowweaverproject) as a study species.

If you would like to be updated with research updates, the easiest way is to follow me on [Bluesky](https://bsky.app/profile/pcapi.bsky.social) and [Instagram](https://www.instagram.com/migralight/). Also, check the [publications page](https://pablocapilla.github.io/publications/) on this website.
